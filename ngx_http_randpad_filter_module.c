...
static ngx_command_t  ngx_http_randpad_filter_commands[] = {
    ...
    { ngx_string("randpad_proxy_store_access"),
    ...
    { ngx_string("randpad_proxy_cache_path"),
    ...
    { ngx_string("randpad_proxy_temp_path"),
    ...
    { ngx_string("randpad_proxy_ssl_session_reuse"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
...
ngx_http_randpad_filter_pass(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    ngx_conf_log_error(NGX_LOG_INFO, cf, 0,  "ngx_http_randpad_filter_pass 0 ");

    if (plcf->upstream.upstream || plcf->proxy_lengths) {
        return "is duplicate";
    }
    ngx_conf_log_error(NGX_LOG_INFO, cf, 0,  "ngx_http_randpad_filter_pass 1");
    clcf = ngx_http_conf_get_module_loc_conf(cf, ngx_http_core_module);
